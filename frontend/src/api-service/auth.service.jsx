...
function AuthService() {
    ...
    const login = async (email, password) => {
        ...
        setLoading(true)
        await axios.post(`${API_BASE_URL}/api/auth-service/auth/signin`, { email: email, password: password })
            .then((response) => {
    ...
    const save = async (userName, email, password) => {
        setLoading(true)
        await axios.post(`${API_BASE_URL}/api/auth-service/auth/signup`, { userName, email, password })
            .then((response) => {
    ...
    const verifyRegistration = async (verificationCode) => {
        setLoading(true)
        await axios.get(`${API_BASE_URL}/api/auth-service/auth/signup/verify`, {
                params: {
    ...
    const resendVerificationCode = async (email) => {
        await axios.get(`${API_BASE_URL}/api/auth-service/auth/signup/resend`, {
                params: {
                    email: email
                }
            })
