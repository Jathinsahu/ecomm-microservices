...
import com.jathinsahu.ecommerce.authservice.dtos.*;
import com.jathinsahu.ecommerce.authservice.exceptions.*;
import com.jathinsahu.ecommerce.authservice.factories.RoleFactory;
import com.jathinsahu.ecommerce.authservice.feigns.NotificationService;
import com.jathinsahu.ecommerce.authservice.modals.Role;
import com.jathinsahu.ecommerce.authservice.modals.User;
import com.jathinsahu.ecommerce.authservice.repositories.UserRepository;
import com.jathinsahu.ecommerce.authservice.security.UserDetailsImpl;
import com.jathinsahu.ecommerce.authservice.security.jwt.JwtUtils;
